...
static CursorPointDirection sCursorPointLinksButWithMusicMenu[] = {
        ...
        /*Mod slop*/ { QUEST_SONG_BOSSA_NOVA, CURSOR_NONE, QUEST_TRACKS, QUEST_FORWARD },          // !!QUEST_REWIND!!
        ...
        /*Mod slop*/ { QUEST_SONG_OATH, CURSOR_NONE, QUEST_REWIND, QUEST_QUIVER },            // !!QUEST_FORWARD!!
        { CURSOR_NONE, QUEST_SONG_TIME, CURSOR_TO_LEFT, QUEST_HEART_PIECE },                  // QUEST_BOMBERS_NOTEBOOK
        { QUEST_SWORD, CURSOR_NONE, QUEST_FORWARD, QUEST_BOMB_BAG },                          // QUEST_QUIVER
        { QUEST_SHIELD, CURSOR_NONE, QUEST_QUIVER, CURSOR_TO_RIGHT },                         // QUEST_BOMB_BAG
        /*Mod slop*/ { QUEST_SONG_LULLABY, CURSOR_NONE, CURSOR_TO_LEFT, QUEST_REWIND },       // !!QUEST_TRACKS!!
